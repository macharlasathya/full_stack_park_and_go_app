...
// import { submitBooking } from '../../App'; // Make sure path is correct
...
//   const basePrice = "20.00"; // Fixed price per hour
...
//   // Handle form submission - matches updated backend structure
...
//     // Create the data object in the format the backend expects
//     const bookingData = {
...
// Add localStorage debugging to find out what's using it
...
const CustomerDetails = () => {
  ...
  // On component mount, check for existing localStorage entries
  useEffect(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Check localStorage after successful submission
