...
// import "../LandingCss/Blogs.css"; // Make sure this path is correct
...
//       <div id="Blogsection" className="blogs-grid-container">
//         {cards.map((card, index) => (
//           <div key={index} className="blogs-card">
//             {card.image ? (
//               <img src={card.image} alt={`Image for ${card.title}`} className="blogs-card-image" />
//             ) : (
//               <div className="blogs-no-image">
//                 <p>Image not available</p>
//               </div>
//             )}
//             <div className="blogs-card-content">
//               <h5 className="blogs-card-title">{card.title}</h5>
//               <p className="blogs-card-text">{card.text}</p>
//               <a href={card.link} className="blogs-card-button">
//                 Read More
//               </a>
//             </div>
//           </div>
...
/* BlogsCustom.css - Completely unique class names to avoid conflicts */
